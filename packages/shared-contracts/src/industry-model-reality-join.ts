...
import type { IndustryDiagnosticClassification, IndustryDiagnosticReadinessStatus } from "./industry-model-diagnostic.js";

export const INDUSTRY_MODEL_REALITY_JOIN_SCHEMA_VERSION =
  "industry-model-reality-join.v1" as const;
...
export type IndustryModelRealityJoinTeacherAdminDto =
  IndustryModelRealityJoinProjectionBase & {
