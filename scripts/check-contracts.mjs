...
if (missingPaths.length > 0) {
  console.error("Missing P0 OpenAPI paths:");
...
for (const schemaPath of ["contracts/schemas/decision-payload.v1.json", "contracts/schemas/settlement-result.v1.json"]) {
  JSON.parse(readFileSync(resolve(schemaPath), "utf8"));
}

console.log("Contract baseline files and P0 paths are present.");
