...
export default defineConfig({
  ...
  testMatch: /role-workflow-product-journey\.spec\.ts/,
  grep: /@role-workflow-real/,
  fullyParallel: false,
  timeout: 60_000,
  workers: 1,
  outputDir: "tmp/playwright/role-workflow-test-results",
  reporter: [["list"]],
  expect: {
    timeout: 10_000
  },
  ...
  webServer: [
    {
      ...
      env: {
        ...
        SIMWAR_ENV: "test",
        SIMWAR_PLAYWRIGHT_ROLE_WORKFLOW: "true",
