...
def validate_input(payload: dict[str, Any]) -> None:
    ...
    _require(isinstance(firm_ids, list) and firm_ids and all(isinstance(item, str) and item for item in firm_ids), "counterfactual.firm_ids must be non-empty strings")
