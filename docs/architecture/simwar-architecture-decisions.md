...
| ADR-DATA-004     | Settlement business idempotency and concurrency policy | accepted | policy-only | settlement / db / repository / replay     | `docs/architecture/adr/ADR-DATA-004-settlement-idempotency-and-concurrency.md`              |
