...
| Full unit suite                 | `npm test`; 1,382 tests across 222 files in the recorded product validation                                                                        | PASS in remote quality gate; a prior load-sensitive ESM startup case required the documented 20s retry locally |
