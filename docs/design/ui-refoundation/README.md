...
| live PR #372     | capture `updatedAt=2026-08-12T16:42:29Z`；OPEN/MERGEABLE/non-draft；head `64fac64bca2138abb33e2db731714ba9bc864254`；base `bb343faf0c38e4a4a6d8b7928d0a0f35ecf8ad37`；quality/browser-smoke/Analyze/CodeQL SUCCESS；6 unresolved threads                                     |
| live PR #365     | OPEN/CONFLICTING；head `0fd0…`；base `675f…`（capture 仅提供前缀）；overlap ownership remains protected                                                                                                                                                                      |
...
The final PR1 lab browser evidence is indexed in `visual-baseline/README.md`:
external root `C:\Users\Marshall\.codex\visualizations\2026\08\12\019ff6ce-99bb-7100-b86c-f47b294d077a\fe-pr1-design-system-lab`,
runtime JSON hash `E5CD...3764F`, and four automated viewports. No
binary evidence is copied into the repository.
...
| [`open-pr-ownership-map.md`](./open-pr-ownership-map.md)                 | #372/#365 live ownership and serial Product PR/Governance boundaries                                      | GitHub preflight                |
...
| ------------------------------------------------------------------------------------------ | ----------------------------------------------------- | --------------------------------------------------------------------------------------- |
| #372 head `64fac64bca2138abb33e2db731714ba9bc864254`, checks SUCCESS                       | current live capture                                  | use for ownership/readback; refresh before final merge                                  |
...
- PR #372 and #365 are external mutable state; refresh live status before rebase/merge. No human approval, pilot, production deployment or human validation is claimed here.
