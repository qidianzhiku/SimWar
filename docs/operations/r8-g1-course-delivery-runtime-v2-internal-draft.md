# R8-G1 Course Delivery Runtime V2 Internal Draft
...
This note records how the `Course Delivery Runtime V2` synthetic evidence
package may be handled during internal review. It is not a release runbook and
does not authorize Pilot or Production activity.
