...
- Verified source head for this receipt: `d7d4a1e136b3699e6a32f829ef58eb07b9d7e2e2`
...
| `npm run measure:frontend:budgets -- --dist-root . --base-sha da6ce87562faaca00a15e6001ea2bdd8ce6b96a6 --head-sha d7d4a1e136b3699e6a32f829ef58eb07b9d7e2e2`                                                                                                 | PASS — Teacher initial JS 421.61 kB / 120.64 kB gzip; all Admin/Teacher/Student budgets within 10% |
...
- Product PR #444 has been created and the branch has been pushed. The final-head required-check rerun, ordinary merge, and detached post-merge verification remain pending.
